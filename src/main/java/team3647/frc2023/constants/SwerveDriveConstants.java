...
public class SwerveDriveConstants {
    ...
    public static final PIDController kAutoSteerYPIDController = new PIDController(10, 0, 0.05);
    // 3*Pi = move at 10 rads per second if we are 180* away from target heading
    public static final PIDController kAutoSteerHeadingController = new PIDController(2, 0, 0);
