...
public class PhotonVisionConstants {
    ...
    public static Transform3d robotToCam = new Transform3d(new Translation3d(0.12, 0.27, Units.inchesToMeters(19.5)), new Rotation3d(0,0,0)); //Cam mounted facing forward, half a meter forward of center, half a meter up from center.
